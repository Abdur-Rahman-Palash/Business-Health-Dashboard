...
class FileUploadManager:
    ...
    def render_file_upload_ui(self, client_name: str = None):
        ...
        with tab1:
            st.subheader("📊 Business Data Files")
            ...
            with col1:
                ...
                csv_file = st.file_uploader(
                    "📈 Upload CSV Data (Sales, Customers, Financials)",
                    type=['csv'],
                    key=f"csv_{client_name}",
                    help="Upload sales data, customer data, financial data in CSV format for advanced analysis"
                )
            ...
            with col2:
                ...
                excel_file = st.file_uploader(
                    "📊 Upload Excel Files (Financial Reports, Data)",
                    type=['xlsx', 'xls'],
                    key=f"excel_{client_name}",
                    help="Upload financial reports, business data in Excel format"
                )
