#!/usr/bin/env python3
"""
Simple Streamlit API Server for Render.com
Provides API endpoints to fix 403 errors
"""
...
class StreamlitAPIHandler(BaseHTTPRequestHandler):
    """Handle API requests for Streamlit dashboard"""
    ...
    def do_GET(self):
        ...
        if parsed_path.path == '/api/health':
            ...
            response = self.handle_dashboard_complete()
    ...
    def do_POST(self):
        ...
        if parsed_path.path == '/api/dashboard/update':
            response = self.handle_dashboard_update()
        else:
            response = {"error": "Endpoint not found", "path": parsed_path.path}
    ...
    def handle_dashboard_complete(self):
    ...
    def handle_dashboard_update(self):
...
def run_api_server():
    """Run the API server"""
    server = HTTPServer(('0.0.0.0', 8081), StreamlitAPIHandler)
    print("🚀 Streamlit API Server running on http://localhost:8081")
    print("📊 Available endpoints:")
    print("   - GET /api/health")
    print("   - GET /api/dashboard/complete")
    print("   - POST /api/dashboard/update")
    print("   - GET /_stcore/health")
